...
import AlertSubscriber from "./components/alert/alertSubscriber.js";
import BlocksComponent from "./components/blocks/blocksComponent.js";
import BlocksSubscriber from "./components/blocks/blocksSubscriber.js";
import ColorFormComponent from "./components/color-form/colorFormComponent.js";
import ColorFormSubscriber from "./components/color-form/colorFormSubscriber.js";
import ContextMenuComponent from "./components/context-menu/contextMenuComponent.js";
import ContextMenuSubscriber from "./components/context-menu/contextMenuSubscriber.js";
import ImageFormComponent from "./components/image-form/imageFormComponent.js";
import ImageFormSubscriber from "./components/image-form/imageFormSubscriber.js";
import LoaderSubscriber from "./components/loader/loaderSubscriber.js";
import MetatagsFormComponent from "./components/metatags-form/metatagsFormComponent.js";
import MetatagsFormSubscriber from "./components/metatags-form/metatagsFormSubscriber.js";
import PromptFormComponent from "./components/prompt-form/promptFormComponent.js";
import PromptFormSubscriber from "./components/prompt-form/promptFormSubscriber.js";
import SaveMenuComponent from "./components/save-menu/saveMenuComponent.js";
...
new LoaderSubscriber();
new AlertSubscriber();

const contextMenuComponent = new ContextMenuComponent();
new ContextMenuSubscriber(contextMenuComponent);
const blocksComponent = new BlocksComponent();
new BlocksSubscriber(blocksComponent);
const imageFormComponent = new ImageFormComponent();
new ImageFormSubscriber(imageFormComponent);
const metatagsFormComponent = new MetatagsFormComponent();
new MetatagsFormSubscriber(metatagsFormComponent);
const colorFormComponent = new ColorFormComponent();
new ColorFormSubscriber(colorFormComponent);
const promptFormComponent = new PromptFormComponent();
new PromptFormSubscriber(promptFormComponent);
const saveMenuComponent = new SaveMenuComponent();

saveMenuComponent.init();

store.sectionStore.init();
store.imageStore.init();
store.metatagsStore.init();
store.promptStore.init();